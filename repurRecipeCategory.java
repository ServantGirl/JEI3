...
public abstract class repurRecipeCategory<T extends IRecipeWrapper> implements IRecipeCategory<T> {
	...
	public repurRecipeCategory(IGuiHelper guiHelper) {
		staticFlame = guiHelper.createDrawable(jeiPluginDD.RECIPE_GUI_VANILLA, 82, 114, 14, 14);
		animatedFlame = guiHelper.createAnimatedDrawable(staticFlame, 300, IDrawableAnimated.StartDirection.TOP, true);

		IDrawableStatic arrowDrawable = guiHelper.createDrawable(jeiPluginDD.RECIPE_GUI_VANILLA, 82, 128, 24, 17);
